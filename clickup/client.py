...
diff --git a/clickup/client.py b/clickup/client.py
index 75c3a253f6d0ada2a1c33257e368cfebaaf36b64..13eca395e642d6e5cd2e2497a6f365ca9e8db67e 100644
--- a/clickup/client.py
+++ b/clickup/client.py
@@ -1,144 +1,227 @@
 """
...
+    """
+    Normalize ClickUp API base URL.
+    Accepts either:
+      - https://api.clickup-stg.com
+      - https://api.clickup-stg.com/api/v2
+    and always returns a base ending in /api/v2.
+    """
...
-        url = _BASE_URL + path
+        base_url = _normalize_base_url(os.getenv("CLICKUP_BASE_URL", _DEFAULT_BASE_URL))
+        url = base_url + path
