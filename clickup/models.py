...
diff --git a/clickup/models.py b/clickup/models.py
index 7462a94f273fe1fe9e63d58e60b53377071cded2..ba444baaa313ad388f62cfb8617aa8c6318e9488 100644
--- a/clickup/models.py
+++ b/clickup/models.py
@@ -48,58 +48,144 @@ def _to_timestamp_ms(date_str: str) -> int | None:
     return None
...
@@ -141,92 +227,120 @@ def build_custom_fields_payload(
